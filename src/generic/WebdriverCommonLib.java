...
public class WebdriverCommonLib extends Basetest{
	...
	public void verifyTitleOftheWebpage(String expectedTitle, String actualTitle, String pageName)
	{
	...
	public void frameByWebElementAddress(WebElement element)
	{
		driver.switchTo().frame(element);
	}

	public void takeSnap(String nameOfTheScreenshot) throws IOException
	{
		...
		File dest = new File("./screenshots/"+nameOfTheScreenshot+".png");
		Files.copy(src, dest);
	}
